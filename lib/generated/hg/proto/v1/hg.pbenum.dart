...
class CmdType extends $pb.ProtobufEnum {
  ...
  static const CmdType CMD_TYPE_START_DFU = CmdType._(3, _omitEnumNames ? '' : 'CMD_TYPE_START_DFU');
  static const CmdType CMD_TYPE_TOGGLE_AP = CmdType._(4, _omitEnumNames ? '' : 'CMD_TYPE_TOGGLE_AP');
  static const CmdType CMD_TYPE_INIT_DFU_BOOT = CmdType._(5, _omitEnumNames ? '' : 'CMD_TYPE_INIT_DFU_BOOT');
...
class DfuType extends $pb.ProtobufEnum {
  ...
  static const DfuType DFU_TYPE_NEW_TO_OLD = DfuType._(2, _omitEnumNames ? '' : 'DFU_TYPE_NEW_TO_OLD');
