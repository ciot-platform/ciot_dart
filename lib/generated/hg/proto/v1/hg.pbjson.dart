...
const CmdType$json = {
  ...
  '2': [
    ...
    {'1': 'CMD_TYPE_START_DFU', '2': 3},
    {'1': 'CMD_TYPE_TOGGLE_AP', '2': 4},
    {'1': 'CMD_TYPE_INIT_DFU_BOOT', '2': 5},
...
final $typed_data.Uint8List cmdTypeDescriptor = $convert.base64Decode(
    ...
    'oOQ01EX1RZUEVfUkVTRVQQAhIWChJDTURfVFlQRV9TVEFSVF9ERlUQAxIWChJDTURfVFlQRV9U'
    'T0dHTEVfQVAQBBIaChZDTURfVFlQRV9JTklUX0RGVV9CT09UEAUSFwoTQ01EX1RZUEVfR0VUX0'
    'hFQUxUSBAGEhkKFUNNRF9UWVBFX1NFVF9ERlVfVFlQRRBjEiUKIUNNRF9UWVBFX0RFTEVURV9N'
    'SUdSQVRFRF9TRVRUSU5HUxBl');
...
final $typed_data.Uint8List dfuTypeDescriptor = $convert.base64Decode(
    'CgdEZnVUeXBlEhAKDERGVV9UWVBFX09MRBAAEhAKDERGVV9UWVBFX05FVxABEhcKE0RGVV9UWV'
    'BFX05FV19UT19PTEQQAg==');
